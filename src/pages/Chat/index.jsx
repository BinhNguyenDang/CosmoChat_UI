...
const Chat = () => {
    ...
    useEffect(() => {
        ...
        const fetchSessions = async () => {
            try {
                // Fetching session from the API 
                const response = await api.get("/sessions");
                // Updating the sessions state with fetched data
                setSessions(response.data);
                // Finding the session with the provided ID and updating the thisSession state
                setThisSession(
                    response.data.find(
    ...
    // Function to call the OpenAI API to get a response from ReX
